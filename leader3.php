<!-- Stage 4 of task 2; login made compulsory-->
<?php
 session_start();
 if(!isset($_SESSION["comp"]))// login made compulsory by using session
 {
	 $_SESSION["log"]=1;
...
<nav class="navbar navbar-default" style="position: absolute; top: 0px;width:100%; height: 5%;" >
  <div class="container-fluid">
	...
	<div class="navbar navbar-nav navbar-right">
	 <a href='login1.php'class='btn btn-info' style="margin-top: 2px;">Logout</a>
	</div>
    </div>
    </nav>
